...
const HEADERS = {
  ...
  // One row per (userId, teamId) a person has ever opened — app-written,
  // never owner-entered. lastReadAt is compared against each message's
  ...
  ChatReads: ['id', 'userId', 'teamId', 'lastReadAt'],
