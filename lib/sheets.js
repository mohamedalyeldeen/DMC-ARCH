...
const HEADERS = {
  Config: ['key', 'value'],
  Teams: ['id', 'name', 'color'],
  Members: ['id', 'name', 'username', 'passwordHash', 'teamId', 'color', 'isTeamLead', 'reportsTo', 'email', 'noOverdueStreak', 'streakLastCheckedDate', 'tasksFinishedEarly', 'isViewer', 'isSenior'],
